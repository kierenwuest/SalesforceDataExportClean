...
Not considering images documents and attachments, not considering Salesfroce files CRM Content document versions.
...
v0.2 This version handles NULL bytes for ISO-8859-1 Encoding and replaces them with space characters.  
